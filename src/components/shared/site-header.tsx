        ...
        <div className="flex items-center h-[56px] md:h-[64px]">
          ...
          <div className="flex items-center gap-2 md:gap-3 flex-shrink-0">
            ...
            <Link href="/" className="flex items-center gap-2">
              <div className="w-9 h-9 rounded-xl overflow-hidden relative bg-white shadow-sm flex-shrink-0 p-1">
                <Image src="/uploads/branding/logo.png" alt="Bliss Bakery" fill className="object-contain" sizes="36px" priority />
              </div>
