        ...
        <div className="md:flex md:gap-8 md:py-2">
          ...
          <div className="md:w-2/5 mb-4 md:mb-0">
            <div className="relative aspect-square rounded-xl overflow-hidden bg-muted">
              <Image src={heroImg} alt={product.name} fill className="object-cover" sizes="(max-width:768px) 100vw,40vw" priority />
              <div className="absolute top-2 left-2 flex gap-1">
                <span className="bg-white/90 backdrop-blur-sm text-[9px] font-medium text-green-700 px-1.5 py-0.5 rounded-full flex items-center gap-0.5"><Leaf className="w-2.5 h-2.5" />Veg</span>
                {product.isBestseller && <span className="bg-primary text-primary-foreground text-[9px] font-medium px-1.5 py-0.5 rounded-full">★ Best</span>}
              </div>
            </div>
          </div>
          ...
          <div className="flex-1">
            ...
            <p className="text-lg font-bold text-primary mb-3">{formatPrice(product.basePrice)}</p>
